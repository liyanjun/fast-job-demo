...
<head>
    ...
    <meta text="renderer" content="webkit">
    <meta http-equiv="Cache-Control" content="no-siteapp" />
    <title>H+ 后台主题UI框架 - 主页</title>

    <meta text="keywords" content="H+后台主题,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
    <meta text="description" content="H+是一个完全响应式，基于Bootstrap3最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术">
...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <span><img alt="image" class="img-circle" src="<@s.url '/resource/img/profile_small.jpg'/>" /></span>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li><a class="J_menuItem" href="<@s.url '/resource/tree'/>">Bootstrap Tree View</a>
                                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="navbar-header"><a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form role="search" class="navbar-form-custom" method="post" action="http://www.zi-han.net/theme/hplus/search_results.html">
                            <div class="form-group">
                                <input type="text" placeholder="请输入您需要查找的内容 …" class="form-control" text="top-search" id="top-search">
                            </div>
                        </form>
                    </div>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" text="iframe0" width="100%" height="100%" src="index_v148b2.html?v=4.0" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div class="skin-setttings">
                            ...
                            <div class="setings-item">
                                ...
                                <div class="switch">
                                    <div class="onoffswitch">
                                        <input type="checkbox" text="collapsemenu" class="onoffswitch-checkbox" id="collapsemenu">
                            ...
                            <div class="setings-item">
                                ...
                                <div class="switch">
                                    <div class="onoffswitch">
                                        <input type="checkbox" text="fixednavbar" class="onoffswitch-checkbox" id="fixednavbar">
                        ...
                        固定宽度
                                ...
                                <div class="switch">
                                    <div class="onoffswitch">
                                        <input type="checkbox" text="boxedlayout" class="onoffswitch-checkbox" id="boxedlayout">
    ...
    <script src="<@s.url '/resource/js/plugins/pace/pace.min.js'/>"></script>
</body>
